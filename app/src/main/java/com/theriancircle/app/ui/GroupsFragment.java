...
import com.theriancircle.app.ui.groups.GroupAdapter;
...
public class GroupsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        adapter = new GroupAdapter(group -> {
            ...
            int message = updated.isJoinedByMe() ? R.string.group_joined : R.string.group_left;
    ...
    private void loadData() {
        ...
        try {
            ...
            if (groups.isEmpty()) {
                showEmpty(getString(R.string.state_empty_groups));
            } else {
                adapter.submitItems(groups);
                showContent();
            }
        } catch (Exception e) {
            showError();
